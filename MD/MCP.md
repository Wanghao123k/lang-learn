...
![MCP 官方架构图](https://oss.open8gu.com/iShot_2026-02-08_21.46.36.png)
...
![MCP 三层架构图](https://oss.open8gu.com/image-20260227171359056.png)
...
![MCP 完整调用流程图](https://oss.open8gu.com/image-20260227173627177.png)
...
![Function Call vs MCP 对比图](https://oss.open8gu.com/image-20260227174510999.png)
...
![Stdio vs Streamable HTTP 选择指南](https://oss.open8gu.com/image-20260227180906767.png)
...
![Cursor MCP 配置界面](https://oss.open8gu.com/image-20260227200317384.png)
...
![Cursor 调用 MCP Server 效果](https://oss.open8gu.com/image-20260227200604554.png)
...
MCP 的真正威力在于多个 Server 协同工作。假设用户问"我的订单 #12345 能退货吗"，这个问题需要两部分信息：
...
![多 Server 协同工作示意图](https://oss.open8gu.com/image-20260227210315852.png)
